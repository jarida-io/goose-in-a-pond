...
- Name: hub-prompts-wiring.spec.ts >> Hub — Prompts sub-screen wiring >> loads preset chips from API and shows active preset body
- Location: tests/e2e/hub-prompts-wiring.spec.ts:134:3
