...
- Name: hub-cameras-wiring.spec.ts >> Hub — Cameras sub-screen wiring >> empty state renders when no camera devices are registered
- Location: tests/e2e/hub-cameras-wiring.spec.ts:193:3
