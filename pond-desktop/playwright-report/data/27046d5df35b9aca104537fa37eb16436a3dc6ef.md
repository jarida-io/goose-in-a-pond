...
- Name: hub-privacy-account-wiring.spec.ts >> Hub — Privacy sub-screen wiring >> loads toggle state and session count from API
- Location: tests/e2e/hub-privacy-account-wiring.spec.ts:170:3
