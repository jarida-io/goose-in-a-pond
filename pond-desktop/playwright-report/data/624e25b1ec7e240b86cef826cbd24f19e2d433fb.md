...
- Name: hub-device-control-wiring.spec.ts >> device tile click fires POST /tools/invoke with the device-control tool
- Location: tests/e2e/hub-device-control-wiring.spec.ts:18:1
