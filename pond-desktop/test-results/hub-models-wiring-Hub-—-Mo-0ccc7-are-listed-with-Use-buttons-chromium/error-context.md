...
- Name: hub-models-wiring.spec.ts >> Hub — Models sub-screen wiring >> speech models are listed with Use buttons
- Location: tests/e2e/hub-models-wiring.spec.ts:213:3
