...
- Name: hub-memory-wiring.spec.ts >> Hub — Memory sub-screen wiring >> shows offline banner and mock fallback when API is unavailable
- Location: tests/e2e/hub-memory-wiring.spec.ts:218:3
