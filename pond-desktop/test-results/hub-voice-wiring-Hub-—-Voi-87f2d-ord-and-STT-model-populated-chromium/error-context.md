...
- Name: hub-voice-wiring.spec.ts >> Hub — Voice sub-screen wiring >> loads with settings: wake word and STT model populated
- Location: tests/e2e/hub-voice-wiring.spec.ts:120:3
