...
- Name: extensions.spec.ts >> Extensions section >> filling the api_key field and clicking Save & Install completes the flow
- Location: tests/e2e/extensions.spec.ts:233:3
