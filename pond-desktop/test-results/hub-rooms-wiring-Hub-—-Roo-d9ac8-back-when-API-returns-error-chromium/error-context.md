...
- Name: hub-rooms-wiring.spec.ts >> Hub — Rooms sub-screen wiring >> shows offline mock fallback when API returns error
- Location: tests/e2e/hub-rooms-wiring.spec.ts:152:3
