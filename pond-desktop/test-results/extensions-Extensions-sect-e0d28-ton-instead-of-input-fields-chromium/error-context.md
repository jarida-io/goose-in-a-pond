...
- Name: extensions.spec.ts >> Extensions section >> OAuth-only extension shows Sign in button instead of input fields
- Location: tests/e2e/extensions.spec.ts:256:3
